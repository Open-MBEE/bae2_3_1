...
public class Power extends ParameterListenerImpl {
    ...
    public class _17_0_2_1_edc0357_1360798765021_125160_20250 extends DurativeEvent {
        ...
        public class _17_0_2_1_edc0357_1360798765440_273045_20572 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765440_273045_20572Members() {
                try {
                    ...
                    effect150 = new EffectFunction(new EffectFunction(effect150Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        public class _17_0_2_1_edc0357_1360798765440_675335_20573 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765440_675335_20573Dependencies() {
                ...
                addDependency(objectToPass, new Expression<Boolean>(new EffectFunction(sig_17_0_2_1_edc0357_1360798765446_873055_20593, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
            }
        ...
        public class _17_0_2_1_edc0357_1360798765441_546996_20574 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765441_546996_20574Members() {
                try {
                    ...
                    if (objectToPass == null) objectToPass = new BooleanParameter("objectToPass", (Boolean) null, this);
                    Object effect152VarV = decider_17_0_2_1_edc0357_1360798765444_162511_20578;
                    effect152Var = new Parameter("effect152Var", null, null, this);
                    addDependency(effect152Var, new Expression(effect152VarV));
                    effect152 = new EffectFunction(new EffectFunction(effect152Var, ClassUtils.getMethodForArgTypes("TimeVaryingList<Integer>", "ROUND_TRIP_TEST", "addIfNotContained", gov.nasa.jpl.ae.event.Parameter.class, java.lang.Object.class, java.lang.Boolean.class), new Object[] { new Expression<Integer>(endTime), new Expression<Integer>(myDeciderID_decider_17_0_2_1_edc0357_1360798765444_162511_20578), new Expression<Boolean>(addToDecider__17_0_2_1_edc0357_1360798765444_162511_20578) }));
                    Object effect153VarV = sig_17_0_2_1_edc0357_1360798765445_230375_20587;
                    effect153Var = new Parameter("effect153Var", null, null, this);
                    addDependency(effect153Var, new Expression(effect153VarV));
                    effect153 = new EffectFunction(new EffectFunction(effect153Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Float>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Double>(_17_0_2_1_edc0357_1360798766254_732299_21881), new Expression<Integer>(endTime) }));
                    Object effect154VarV = sig_17_0_2_1_edc0357_1360878970443_16585_15933;
                    effect154Var = new Parameter("effect154Var", null, null, this);
                    addDependency(effect154Var, new Expression(effect154VarV));
                    effect154 = new EffectFunction(new EffectFunction(effect154Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360798765441_546996_20574Dependencies() {
                ...
                addDependency(_17_0_2_1_edc0357_1360798765444_162511_20578_exists, new Expression<Boolean>(new Functions.And(new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Functions.Equals(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765440_675335_20573_exists), null)), new Expression<Boolean>(new Functions.Not(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765440_675335_20573_exists)))))), new Expression<Boolean>(new Functions.Less(new Expression<Integer>(new Functions.Plus(new Expression<Integer>(endTime), new Expression<Integer>(2))), new Expression<Integer>(finalNode_startTime)))))), new Expression<Boolean>(new Expression<Boolean>(new Functions.And(new Expression<Boolean>(new Functions.Equals(new Expression(new EffectFunction(decider_17_0_2_1_edc0357_1360798765444_162511_20578, ClassUtils.getMethodForArgTypes("TimeVaryingList<Integer>", "ROUND_TRIP_TEST", "size", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(endTime) })), new Expression(new EffectFunction(decider_17_0_2_1_edc0357_1360798765444_162511_20578, ClassUtils.getMethodForArgTypes("TimeVaryingList<Integer>", "ROUND_TRIP_TEST", "maxSize"), new Object[] {})))), new Expression<Boolean>(new Functions.Equals(new Expression(new EffectFunction(decider_17_0_2_1_edc0357_1360798765444_162511_20578, ClassUtils.getMethodForArgTypes("TimeVaryingList<Integer>", "ROUND_TRIP_TEST", "lastElement", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(endTime) })), new Expression<Integer>(myDeciderID_decider_17_0_2_1_edc0357_1360798765444_162511_20578)))))))));
                addDependency(_17_0_2_1_edc0357_1360798766254_732299_21881, new Expression<Double>(new FunctionCall(null, ClassUtils.getMethodForArgTypes("null", "ROUND_TRIP_TEST", "getValue"), new Object[] { new Expression<Integer>(startTime) }, new EffectFunction(genProfile__17_0_2_1_edc0357_1360798765028_430905_20259, ClassUtils.getMethodForArgTypes("TimeVaryingProjection<Float>", "ROUND_TRIP_TEST", "getValue", java.lang.Integer.class), new Object[] { startTime }))));
                ...
                addDependency(objectToPass, new Expression<Boolean>(new EffectFunction(sig_17_0_2_1_edc0357_1360878965913_511003_15928, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
            }
            ...
            public void init_17_0_2_1_edc0357_1360798765441_546996_20574Elaborations() {
                ...
                Expression<Boolean> condition155 = new Expression<Boolean>(_17_0_2_1_edc0357_1360798765444_162511_20578_exists);
                elaborationRule155 = addElaborationRule(condition155, _17_0_2_1_edc0357_1360798765021_125160_20250.this, Power._17_0_2_1_edc0357_1360798765021_125160_20250._17_0_2_1_edc0357_1360798765444_162511_20578.class, "PGen_add_augment__CallBehaviorAction__generate__Power", arguments155);
                ...
                Expression<Boolean> condition156 = new Expression<Boolean>(_17_0_2_1_edc0357_1360798765443_547604_20577_exists);
                elaborationRule156 = addElaborationRule(condition156, _17_0_2_1_edc0357_1360798765021_125160_20250.this, Power._17_0_2_1_edc0357_1360798765021_125160_20250._17_0_2_1_edc0357_1360798765443_547604_20577.class, "PGen_read_augment__ReadStructuralFeatureAction__generate__Power", arguments156);
            }
        }
        ...
        public class _17_0_2_1_edc0357_1360798765442_572902_20575 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765442_572902_20575Members() {
                try {
                    ...
                    effect157 = new EffectFunction(new EffectFunction(effect157Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                    Object effect158VarV = new FunctionCall(signalObject, Parameter.class, "getMember", new Object[] { "actual_power__17_0_2_1_edc0357_1360798765096_597525_20352" });
                    effect158Var = new Parameter("effect158Var", null, null, this);
                    addDependency(effect158Var, new Expression(effect158VarV));
                    effect158 = new EffectFunction(new EffectFunction(null, ClassUtils.getMethodForArgTypes("TimeVaryingMap<Float>", "ROUND_TRIP_TEST", "setValue", gov.nasa.jpl.ae.event.Parameter.class, java.lang.Object.class), new Object[] { new Expression<Integer>(endTime), new Expression<Double>(_17_0_2_1_edc0357_1360798766255_580546_21884) }, effect158Var));
                    Object effect159VarV = new FunctionCall(x, Parameter.class, "getMember", new Object[] { "ss_17_0_2_1_edc0357_1360798765028_640858_20258_receiveGenReading" });
                    effect159Var = new Parameter("effect159Var", null, null, this);
                    addDependency(effect159Var, new Expression(effect159VarV));
                    effect159 = new EffectFunction(new EffectFunction(null, ClassUtils.getMethodForArgTypes("ObjectFlow<SignalreceiveGenReading>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Power_System.SignalreceiveGenReading>(signalObject), new Expression<Integer>(endTime) }, effect159Var));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360798765442_572902_20575Dependencies() {
                ...
                addDependency(objectToPass, new Expression<Boolean>(new EffectFunction(sig_17_0_2_1_edc0357_1360798765446_942231_20592, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
            }
        ...
        public class _17_0_2_1_edc0357_1360798765443_547604_20577 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765443_547604_20577Members() {
                try {
                    ...
                    if (objectToPass == null) objectToPass = new BooleanParameter("objectToPass", (Boolean) null, this);
                    Object effect160VarV = decider_17_0_2_1_edc0357_1360798765444_162511_20578;
                    effect160Var = new Parameter("effect160Var", null, null, this);
                    addDependency(effect160Var, new Expression(effect160VarV));
                    effect160 = new EffectFunction(new EffectFunction(effect160Var, ClassUtils.getMethodForArgTypes("TimeVaryingList<Integer>", "ROUND_TRIP_TEST", "addIfNotContained", gov.nasa.jpl.ae.event.Parameter.class, java.lang.Object.class, java.lang.Boolean.class), new Object[] { new Expression<Integer>(endTime), new Expression<Integer>(myDeciderID_decider_17_0_2_1_edc0357_1360798765444_162511_20578), new Expression<Boolean>(addToDecider__17_0_2_1_edc0357_1360798765444_162511_20578) }));
                    Object effect161VarV = sig_17_0_2_1_edc0357_1360798765445_246064_20588;
                    effect161Var = new Parameter("effect161Var", null, null, this);
                    addDependency(effect161Var, new Expression(effect161VarV));
                    effect161 = new EffectFunction(new EffectFunction(effect161Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Float>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Double>(_17_0_2_1_edc0357_1360798766256_140761_21885), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360798765443_547604_20577Dependencies() {
                addDependency(_17_0_2_1_edc0357_1360798765444_162511_20578_exists, new Expression<Boolean>(new Functions.And(new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Functions.Equals(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765440_675335_20573_exists), null)), new Expression<Boolean>(new Functions.Not(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765440_675335_20573_exists)))))), new Expression<Boolean>(new Functions.Less(new Expression<Integer>(new Functions.Plus(new Expression<Integer>(endTime), new Expression<Integer>(2))), new Expression<Integer>(finalNode_startTime)))))), new Expression<Boolean>(new Expression<Boolean>(new Functions.And(new Expression<Boolean>(new Functions.Equals(new Expression(new EffectFunction(decider_17_0_2_1_edc0357_1360798765444_162511_20578, ClassUtils.getMethodForArgTypes("TimeVaryingList<Integer>", "ROUND_TRIP_TEST", "size", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(endTime) })), new Expression(new EffectFunction(decider_17_0_2_1_edc0357_1360798765444_162511_20578, ClassUtils.getMethodForArgTypes("TimeVaryingList<Integer>", "ROUND_TRIP_TEST", "maxSize"), new Object[] {})))), new Expression<Boolean>(new Functions.Equals(new Expression(new EffectFunction(decider_17_0_2_1_edc0357_1360798765444_162511_20578, ClassUtils.getMethodForArgTypes("TimeVaryingList<Integer>", "ROUND_TRIP_TEST", "lastElement", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(endTime) })), new Expression<Integer>(myDeciderID_decider_17_0_2_1_edc0357_1360798765444_162511_20578)))))))));
                addDependency(_17_0_2_1_edc0357_1360798766256_140761_21885, new Expression<Double>(new EffectFunction(powerAugmentation__17_0_2_1_edc0357_1360798765029_789574_20260, ClassUtils.getMethodForArgTypes("TimeVaryingMap<Float>", "ROUND_TRIP_TEST", "getValue", java.lang.Integer.class), new Object[] { new Expression<Integer>(startTime) })));
                addDependency(addToDecider__17_0_2_1_edc0357_1360798765444_162511_20578, new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Functions.Equals(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765440_675335_20573_exists), null)), new Expression<Boolean>(new Functions.Not(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765440_675335_20573_exists)))))), new Expression<Boolean>(new Functions.Less(new Expression<Integer>(new Functions.Plus(new Expression<Integer>(endTime), new Expression<Integer>(2))), new Expression<Integer>(finalNode_startTime)))))));
                addDependency(duration, new Expression<Integer>(1));
                addDependency(myDeciderID_decider_17_0_2_1_edc0357_1360798765444_162511_20578, new Expression<Integer>(2));
                addDependency(objectToPass, new Expression<Boolean>(new EffectFunction(sig_17_0_2_1_edc0357_1360878970443_16585_15933, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
            }
        ...
        public class _17_0_2_1_edc0357_1360798765444_162511_20578 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765444_162511_20578Members() {
                try {
                    ...
                    effect163 = new EffectFunction(new EffectFunction(effect163Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Float>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Double>(_17_0_2_1_edc0357_1360798766257_871897_21887), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360798765444_162511_20578Dependencies() {
                ...
                addDependency(_17_0_2_1_edc0357_1360798766257_118217_21888, new Expression<Double>(new EffectFunction(sig_17_0_2_1_edc0357_1360798765445_230375_20587, ClassUtils.getMethodForArgTypes("ObjectFlow<Float>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
                addDependency(_17_0_2_1_edc0357_1360798766257_871897_21887, new Expression<Double>(total));
                addDependency(_17_0_2_1_edc0357_1360798766258_891416_21889, new Expression<Double>(new EffectFunction(sig_17_0_2_1_edc0357_1360798765445_246064_20588, ClassUtils.getMethodForArgTypes("ObjectFlow<Float>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
        ...
        public class _17_0_2_1_edc0357_1360798765444_561758_20579 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765444_561758_20579Members() {
                try {
                    ...
                    Object effect165VarV = decider_17_0_2_1_edc0357_1360798765442_572902_20575;
                    effect165Var = new Parameter("effect165Var", null, null, this);
                    addDependency(effect165Var, new Expression(effect165VarV));
                    effect165 = new EffectFunction(new EffectFunction(effect165Var, ClassUtils.getMethodForArgTypes("TimeVaryingList<Integer>", "ROUND_TRIP_TEST", "addIfNotContained", gov.nasa.jpl.ae.event.Parameter.class, java.lang.Object.class, java.lang.Boolean.class), new Object[] { new Expression<Integer>(endTime), new Expression<Integer>(myDeciderID_decider_17_0_2_1_edc0357_1360798765442_572902_20575), new Expression<Boolean>(addToDecider__17_0_2_1_edc0357_1360798765442_572902_20575) }));
                    Object effect166VarV = sig_17_0_2_1_edc0357_1360798765445_206282_20582;
                    effect166Var = new Parameter("effect166Var", null, null, this);
                    addDependency(effect166Var, new Expression(effect166VarV));
                    effect166 = new EffectFunction(new EffectFunction(effect166Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Float>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Double>(objectToPass), new Expression<Integer>(endTime) }));
                    Object effect167VarV = sig_17_0_2_1_edc0357_1360798765446_108540_20591;
                    effect167Var = new Parameter("effect167Var", null, null, this);
                    addDependency(effect167Var, new Expression(effect167VarV));
                    effect167 = new EffectFunction(new EffectFunction(effect167Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Float>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Double>(objectToPass), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360798765444_561758_20579Dependencies() {
                addDependency(_17_0_2_1_edc0357_1360798765442_572902_20575_exists, new Expression<Boolean>(new Functions.And(new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Functions.Equals(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765440_675335_20573_exists), null)), new Expression<Boolean>(new Functions.Not(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765440_675335_20573_exists)))))), new Expression<Boolean>(new Functions.Less(new Expression<Integer>(new Functions.Plus(new Expression<Integer>(endTime), new Expression<Integer>(2))), new Expression<Integer>(finalNode_startTime)))))), new Expression<Boolean>(new Expression<Boolean>(new Functions.And(new Expression<Boolean>(new Functions.Equals(new Expression(new EffectFunction(decider_17_0_2_1_edc0357_1360798765442_572902_20575, ClassUtils.getMethodForArgTypes("TimeVaryingList<Integer>", "ROUND_TRIP_TEST", "size", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(endTime) })), new Expression(new EffectFunction(decider_17_0_2_1_edc0357_1360798765442_572902_20575, ClassUtils.getMethodForArgTypes("TimeVaryingList<Integer>", "ROUND_TRIP_TEST", "maxSize"), new Object[] {})))), new Expression<Boolean>(new Functions.Equals(new Expression(new EffectFunction(decider_17_0_2_1_edc0357_1360798765442_572902_20575, ClassUtils.getMethodForArgTypes("TimeVaryingList<Integer>", "ROUND_TRIP_TEST", "lastElement", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(endTime) })), new Expression<Integer>(myDeciderID_decider_17_0_2_1_edc0357_1360798765442_572902_20575)))))))));
                ...
                addDependency(objectToPass, new Expression<Double>(new EffectFunction(sig_17_0_2_1_edc0357_1360798765446_227708_20589, ClassUtils.getMethodForArgTypes("ObjectFlow<Float>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
            }
        ...
        public class _17_0_2_1_edc0357_1360798765444_866435_20580 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765444_866435_20580Members() {
                try {
                    ...
                    if (objectToPass == null) objectToPass = new BooleanParameter("objectToPass", (Boolean) null, this);
                    Object effect170VarV = decider_17_0_2_1_edc0357_1360798765442_572902_20575;
                    effect170Var = new Parameter("effect170Var", null, null, this);
                    addDependency(effect170Var, new Expression(effect170VarV));
                    effect170 = new EffectFunction(new EffectFunction(effect170Var, ClassUtils.getMethodForArgTypes("TimeVaryingList<Integer>", "ROUND_TRIP_TEST", "addIfNotContained", gov.nasa.jpl.ae.event.Parameter.class, java.lang.Object.class, java.lang.Boolean.class), new Object[] { new Expression<Integer>(endTime), new Expression<Integer>(myDeciderID_decider_17_0_2_1_edc0357_1360798765442_572902_20575), new Expression<Boolean>(addToDecider__17_0_2_1_edc0357_1360798765442_572902_20575) }));
                    Object effect171VarV = power__17_0_2_1_edc0357_1360798765025_253187_20253;
                    effect171Var = new Parameter("effect171Var", null, null, this);
                    addDependency(effect171Var, new Expression(effect171VarV));
                    effect171 = new EffectFunction(new EffectFunction(effect171Var, ClassUtils.getMethodForArgTypes("TimeVaryingPlottableMap<Float>", "ROUND_TRIP_TEST", "setValue", gov.nasa.jpl.ae.event.Parameter.class, java.lang.Object.class), new Object[] { new Expression<Integer>(startTime), new Expression<Double>(_17_0_2_1_edc0357_1360798766259_77770_21890) }));
                    Object effect172VarV = sig_17_0_2_1_edc0357_1360798765446_942231_20592;
                    effect172Var = new Parameter("effect172Var", null, null, this);
                    addDependency(effect172Var, new Expression(effect172VarV));
                    effect172 = new EffectFunction(new EffectFunction(effect172Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360798765444_866435_20580Dependencies() {
                addDependency(_17_0_2_1_edc0357_1360798765442_572902_20575_exists, new Expression<Boolean>(new Functions.And(new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Functions.Equals(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765440_675335_20573_exists), null)), new Expression<Boolean>(new Functions.Not(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765440_675335_20573_exists)))))), new Expression<Boolean>(new Functions.Less(new Expression<Integer>(new Functions.Plus(new Expression<Integer>(endTime), new Expression<Integer>(2))), new Expression<Integer>(finalNode_startTime)))))), new Expression<Boolean>(new Expression<Boolean>(new Functions.And(new Expression<Boolean>(new Functions.Equals(new Expression(new EffectFunction(decider_17_0_2_1_edc0357_1360798765442_572902_20575, ClassUtils.getMethodForArgTypes("TimeVaryingList<Integer>", "ROUND_TRIP_TEST", "size", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(endTime) })), new Expression(new EffectFunction(decider_17_0_2_1_edc0357_1360798765442_572902_20575, ClassUtils.getMethodForArgTypes("TimeVaryingList<Integer>", "ROUND_TRIP_TEST", "maxSize"), new Object[] {})))), new Expression<Boolean>(new Functions.Equals(new Expression(new EffectFunction(decider_17_0_2_1_edc0357_1360798765442_572902_20575, ClassUtils.getMethodForArgTypes("TimeVaryingList<Integer>", "ROUND_TRIP_TEST", "lastElement", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(endTime) })), new Expression<Integer>(myDeciderID_decider_17_0_2_1_edc0357_1360798765442_572902_20575)))))))));
                addDependency(_17_0_2_1_edc0357_1360798766259_77770_21890, new Expression<Double>(new EffectFunction(sig_17_0_2_1_edc0357_1360798765446_108540_20591, ClassUtils.getMethodForArgTypes("ObjectFlow<Float>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
                addDependency(addToDecider__17_0_2_1_edc0357_1360798765442_572902_20575, new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Functions.Equals(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765440_675335_20573_exists), null)), new Expression<Boolean>(new Functions.Not(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765440_675335_20573_exists)))))), new Expression<Boolean>(new Functions.Less(new Expression<Integer>(new Functions.Plus(new Expression<Integer>(endTime), new Expression<Integer>(2))), new Expression<Integer>(finalNode_startTime)))))));
                addDependency(duration, new Expression<Integer>(1));
        ...
        public void init_17_0_2_1_edc0357_1360798765021_125160_20250Elaborations() {
            ...
            arguments148[0] = new Expression<Integer>(finalNode_startTime);
            Expression<Boolean> condition148 = new Expression<Boolean>(_17_0_2_1_edc0357_1360798765440_675335_20573_exists);
            elaborationRule148 = addElaborationRule(condition148, _17_0_2_1_edc0357_1360798765021_125160_20250.this, Power._17_0_2_1_edc0357_1360798765021_125160_20250._17_0_2_1_edc0357_1360798765440_675335_20573.class, "PGen_final__ActivityFinalNode__generate__Power", arguments148);
            Expression<?>[] arguments149 = new Expression<?>[1];
            arguments149[0] = new Expression<Integer>(startTime);
            Expression<Boolean> condition149 = new Expression<Boolean>(true);
            elaborationRule149 = addElaborationRule(condition149, _17_0_2_1_edc0357_1360798765021_125160_20250.this, Power._17_0_2_1_edc0357_1360798765021_125160_20250._17_0_2_1_edc0357_1360798765440_273045_20572.class, "PGen_start__InitialNode__generate__Power", arguments149);
        }
    }
    ...
    public class _17_0_2_1_edc0357_1360798765022_187244_20251 extends DurativeEvent {
        ...
        public class _17_0_2_1_edc0357_1360798765461_594674_20615 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765461_594674_20615Members() {
                try {
                    ...
                    effect176 = new EffectFunction(new EffectFunction(effect176Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        public class _17_0_2_1_edc0357_1360798765462_670651_20617 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765462_670651_20617Members() {
                try {
                    ...
                    effect178 = new EffectFunction(new EffectFunction(effect178Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                    ...
                    effect179 = new EffectFunction(new EffectFunction(effect179Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                    ...
                    effect180 = new EffectFunction(new EffectFunction(effect180Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                    Object effect181VarV = sig_17_0_2_1_edc0357_1360798765477_773280_20663;
                    effect181Var = new Parameter("effect181Var", null, null, this);
                    addDependency(effect181Var, new Expression(effect181VarV));
                    effect181 = new EffectFunction(new EffectFunction(effect181Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                    Object effect182VarV = sig_17_0_2_1_edc0357_1360798765477_934669_20662;
                    effect182Var = new Parameter("effect182Var", null, null, this);
                    addDependency(effect182Var, new Expression(effect182VarV));
                    effect182 = new EffectFunction(new EffectFunction(effect182Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360798765462_670651_20617Dependencies() {
                ...
                addDependency(duration, new Expression<Integer>(1));
                addDependency(objectToPass, new Expression<Boolean>(new EffectFunction(sig_17_0_2_1_edc0357_1360798765475_844019_20645, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
            }
            ...
            public void init_17_0_2_1_edc0357_1360798765462_670651_20617Elaborations() {
                ...
                Expression<?>[] arguments183 = new Expression<?>[1];
                arguments183[0] = new Expression<Integer>(new Functions.Plus(new Expression<Integer>(endTime), new Expression<Integer>(2)));
                Expression<Boolean> condition183 = new Expression<Boolean>(_17_0_2_1_edc0357_1360798765470_351482_20629_exists);
                elaborationRule183 = addElaborationRule(condition183, _17_0_2_1_edc0357_1360798765022_187244_20251.this, Power._17_0_2_1_edc0357_1360798765022_187244_20251._17_0_2_1_edc0357_1360798765470_351482_20629.class, "powerCBTimer__AcceptEventAction__PowerCB__Power", arguments183);
                ...
                elaborationRule184 = addElaborationRule(condition184, _17_0_2_1_edc0357_1360798765022_187244_20251.this, Power._17_0_2_1_edc0357_1360798765022_187244_20251._17_0_2_1_edc0357_1360798765466_933706_20623.class, "P_change_m__MergeNode__PowerCB__Power", arguments184);
                ...
                arguments186[1] = new Expression<ObjectFlow<Boolean>>(sig_17_0_2_1_edc0357_1360798765475_531734_20647);
                Expression<Boolean> condition186 = new Expression<Boolean>(_17_0_2_1_edc0357_1360798765467_857766_20624_exists);
                elaborationRule186 = addElaborationRule(condition186, _17_0_2_1_edc0357_1360798765022_187244_20251.this, Power._17_0_2_1_edc0357_1360798765022_187244_20251._17_0_2_1_edc0357_1360798765467_857766_20624.class, "P_load_m__MergeNode__PowerCB__Power", arguments186);
                ...
                arguments187[1] = new Expression<ObjectFlow<Boolean>>(sig_17_0_2_1_edc0357_1360798765477_773280_20663);
                Expression<Boolean> condition187 = new Expression<Boolean>(_17_0_2_1_edc0357_1360798765472_324054_20632_exists);
                elaborationRule187 = addElaborationRule(condition187, _17_0_2_1_edc0357_1360798765022_187244_20251.this, Power._17_0_2_1_edc0357_1360798765022_187244_20251._17_0_2_1_edc0357_1360798765472_324054_20632.class, "P_merge_feeders__MergeNode__PowerCB__Power", arguments187);
            }
        }
        ...
        public class _17_0_2_1_edc0357_1360798765463_38238_20618 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765463_38238_20618Members() {
                try {
                    ...
                    effect188 = new EffectFunction(new EffectFunction(effect188Var, ClassUtils.getMethodForArgTypes("ObjectFlow<SignalchangeLoadValue>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Power_System.SignalchangeLoadValue>(_17_0_2_1_edc0357_1360798766306_121376_21907), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360798765463_38238_20618Dependencies() {
                ...
                addDependency(_17_0_2_1_edc0357_1360798766306_121376_21907, new Expression<Power_System.SignalchangeLoadValue>(new EffectFunction(q_Power_changeLoadValue, ClassUtils.getMethodForArgTypes("ObjectFlow<SignalchangeLoadValue>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
                addDependency(duration, new Expression<Integer>(1));
                addDependency(objectToPass, new Expression<Boolean>(new EffectFunction(sig_17_0_2_1_edc0357_1360798765475_964511_20649, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
            }
        ...
        public class _17_0_2_1_edc0357_1360798765463_360893_20619 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765463_360893_20619Members() {
                try {
                    ...
                    effect190 = new EffectFunction(new EffectFunction(effect190Var, ClassUtils.getMethodForArgTypes("ObjectFlow<SignalchangeGenerationValue>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Power_System.SignalchangeGenerationValue>(_17_0_2_1_edc0357_1360798766307_585895_21909), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360798765463_360893_20619Dependencies() {
                ...
                addDependency(_17_0_2_1_edc0357_1360798766307_585895_21909, new Expression<Power_System.SignalchangeGenerationValue>(new EffectFunction(q_Power_changeGenerationValue, ClassUtils.getMethodForArgTypes("ObjectFlow<SignalchangeGenerationValue>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
                addDependency(duration, new Expression<Integer>(1));
                addDependency(objectToPass, new Expression<Boolean>(new EffectFunction(sig_17_0_2_1_edc0357_1360798765475_501086_20648, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
            }
        ...
        public class _17_0_2_1_edc0357_1360798765465_127271_20622 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765465_127271_20622Members() {
                try {
                    ...
                    effect192 = new EffectFunction(new EffectFunction(effect192Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360798765465_127271_20622Dependencies() {
                ...
                addDependency(objectToPass, new Expression<Boolean>(new EffectFunction(sig_17_0_2_1_edc0357_1360798765476_584348_20650, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
            }
            ...
            public void init_17_0_2_1_edc0357_1360798765465_127271_20622Elaborations() {
                ...
                arguments193[0] = new Expression<Integer>(startTime);
                arguments193[1] = new Expression<DurativeEvent>(this);
                Expression<Boolean> condition193 = new Expression<Boolean>(true);
                elaborationRule193 = addElaborationRule(condition193, Power.this, Power._17_0_2_1_edc0357_1360798765021_125160_20250.class, "generate__Activity__Power__Power", arguments193);
                ...
                Expression<Boolean> condition194 = new Expression<Boolean>(_17_0_2_1_edc0357_1360798765471_478130_20630_exists);
                elaborationRule194 = addElaborationRule(condition194, _17_0_2_1_edc0357_1360798765022_187244_20251.this, Power._17_0_2_1_edc0357_1360798765022_187244_20251._17_0_2_1_edc0357_1360798765471_478130_20630.class, "P_gen_timer__AcceptEventAction__PowerCB__Power", arguments194);
            }
        }
        ...
        public class _17_0_2_1_edc0357_1360798765466_933706_20623 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765466_933706_20623Members() {
                try {
                    ...
                    effect195 = new EffectFunction(new EffectFunction(effect195Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360798765466_933706_20623Dependencies() {
                addDependency(_17_0_2_1_edc0357_1360798765463_360893_20619_exists, new Expression<Boolean>(new Functions.And(new Expression(new EffectFunction(q_Power_changeGenerationValue, ClassUtils.getMethodForArgTypes("ObjectFlow<SignalchangeGenerationValue>", "ROUND_TRIP_TEST", "hasStuff", java.lang.Integer.class), new Object[] { new Expression<Integer>(endTime) })), new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Functions.Equals(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765468_931127_20626_exists), null)), new Expression<Boolean>(new Functions.Not(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765468_931127_20626_exists)))))), new Expression<Boolean>(new Functions.Less(new Expression<Integer>(new Functions.Plus(new Expression<Integer>(endTime), new Expression<Integer>(2))), new Expression<Integer>(finalNode_startTime)))))))));
                addDependency(endTime, new Expression<Integer>(new FunctionCall(null, ClassUtils.getMethodForArgTypes("Math", "ROUND_TRIP_TEST", "min", int.class, int.class), new Object[] { new Expression(new EffectFunction(q_Power_changeGenerationValue, ClassUtils.getMethodForArgTypes("ObjectFlow<SignalchangeGenerationValue>", "ROUND_TRIP_TEST", "nextTimeHasStuff", java.lang.Integer.class), new Object[] { new Expression<Integer>(startTime) })), new Expression<Integer>(finalNode_endTime) })));
        ...
        public class _17_0_2_1_edc0357_1360798765467_857766_20624 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765467_857766_20624Members() {
                try {
                    ...
                    effect197 = new EffectFunction(new EffectFunction(effect197Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360798765467_857766_20624Dependencies() {
                addDependency(_17_0_2_1_edc0357_1360798765463_38238_20618_exists, new Expression<Boolean>(new Functions.And(new Expression(new EffectFunction(q_Power_changeLoadValue, ClassUtils.getMethodForArgTypes("ObjectFlow<SignalchangeLoadValue>", "ROUND_TRIP_TEST", "hasStuff", java.lang.Integer.class), new Object[] { new Expression<Integer>(endTime) })), new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Functions.Equals(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765468_931127_20626_exists), null)), new Expression<Boolean>(new Functions.Not(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765468_931127_20626_exists)))))), new Expression<Boolean>(new Functions.Less(new Expression<Integer>(new Functions.Plus(new Expression<Integer>(endTime), new Expression<Integer>(2))), new Expression<Integer>(finalNode_startTime)))))))));
                addDependency(endTime, new Expression<Integer>(new FunctionCall(null, ClassUtils.getMethodForArgTypes("Math", "ROUND_TRIP_TEST", "min", int.class, int.class), new Object[] { new Expression(new EffectFunction(q_Power_changeLoadValue, ClassUtils.getMethodForArgTypes("ObjectFlow<SignalchangeLoadValue>", "ROUND_TRIP_TEST", "nextTimeHasStuff", java.lang.Integer.class), new Object[] { new Expression<Integer>(startTime) })), new Expression<Integer>(finalNode_endTime) })));
                addDependency(objectToPass, new Expression<Boolean>(new EffectFunction(receiveThis, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
            }
        ...
        public class _17_0_2_1_edc0357_1360798765467_815816_20625 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765467_815816_20625Members() {
                try {
                    ...
                    effect199 = new EffectFunction(new EffectFunction(effect199Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        public class _17_0_2_1_edc0357_1360798765468_931127_20626 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765468_931127_20626Dependencies() {
                ...
                addDependency(endTime, new Expression<Integer>(new Functions.Plus(new Expression<Integer>(startTime), new Expression<Integer>(duration))));
                addDependency(finalNode_endTime, new Expression<Integer>(endTime));
                addDependency(objectToPass, new Expression<Boolean>(new EffectFunction(sig_17_0_2_1_edc0357_1360798765477_693138_20658, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
            }
        ...
        public class _17_0_2_1_edc0357_1360798765468_517742_20627 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765468_517742_20627Members() {
                try {
                    ...
                    effect201 = new EffectFunction(new EffectFunction(effect201Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Float>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Double>(_17_0_2_1_edc0357_1360798766309_159629_21912), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360798765468_517742_20627Dependencies() {
                addDependency(_17_0_2_1_edc0357_1360798766309_159629_21912, new Expression<Double>(new EffectFunction(null, ClassUtils.getMethodForArgTypes("TimeVaryingMap<Float>", "ROUND_TRIP_TEST", "getValue", java.lang.Integer.class), new Object[] { new Expression<Integer>(startTime) }, new FunctionCall(_17_0_2_1_edc0357_1360798766309_83168_21913, Parameter.class, "getMember", new Object[] { "load__17_0_2_1_edc0357_1360798765030_737782_20262" }))));
                addDependency(_17_0_2_1_edc0357_1360798766309_83168_21913, new Expression<Power_System.SignalchangeLoadValue>(new EffectFunction(sig_17_0_2_1_edc0357_1360798765476_99835_20653, ClassUtils.getMethodForArgTypes("ObjectFlow<SignalchangeLoadValue>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
        ...
        public class _17_0_2_1_edc0357_1360798765469_417764_20628 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765469_417764_20628Members() {
                try {
                    ...
                    effect203 = new EffectFunction(new EffectFunction(effect203Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Float>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Double>(_17_0_2_1_edc0357_1360798766310_329451_21914), new Expression<Integer>(endTime) }));
                    ...
                    effect204 = new EffectFunction(new EffectFunction(effect204Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360798765469_417764_20628Dependencies() {
                addDependency(_17_0_2_1_edc0357_1360798766310_329451_21914, new Expression<Double>(new EffectFunction(null, ClassUtils.getMethodForArgTypes("TimeVaryingMap<Float>", "ROUND_TRIP_TEST", "getValue", java.lang.Integer.class), new Object[] { new Expression<Integer>(startTime) }, new FunctionCall(_17_0_2_1_edc0357_1360798766311_546066_21915, Parameter.class, "getMember", new Object[] { "newGenValue__17_0_2_1_edc0357_1360798765030_16604_20261" }))));
                addDependency(_17_0_2_1_edc0357_1360798766311_546066_21915, new Expression<Power_System.SignalchangeGenerationValue>(new EffectFunction(sig_17_0_2_1_edc0357_1360798765476_487996_20655, ClassUtils.getMethodForArgTypes("ObjectFlow<SignalchangeGenerationValue>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
            ...
            public void init_17_0_2_1_edc0357_1360798765469_417764_20628Elaborations() {
                ...
                elaborationRule205 = addElaborationRule(condition205, _17_0_2_1_edc0357_1360798765022_187244_20251.this, Power._17_0_2_1_edc0357_1360798765022_187244_20251._17_0_2_1_edc0357_1360878700672_703950_15878.class, "Pchange_send_change_confirm__SendSignalAction__PowerCB__Power", arguments205);
                ...
                elaborationRule206 = addElaborationRule(condition206, _17_0_2_1_edc0357_1360798765022_187244_20251.this, Power._17_0_2_1_edc0357_1360798765022_187244_20251._17_0_2_1_edc0357_1360878683758_623651_15865.class, "Pchange_set_aug__AddStructuralFeatureValueAction__PowerCB__Power", arguments206);
            }
        }
        ...
        public class _17_0_2_1_edc0357_1360798765470_351482_20629 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765470_351482_20629Members() {
                try {
                    ...
                    effect207 = new EffectFunction(new EffectFunction(effect207Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360798765470_351482_20629Dependencies() {
                ...
                addDependency(finalNode_startTime, new Expression<Integer>(new Functions.Plus(new Expression<Integer>(endTime), new Expression<Integer>(2))));
                addDependency(objectToPass, new Expression<Boolean>(new EffectFunction(sig_17_0_2_1_edc0357_1360798765477_681208_20657, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
            }
        ...
        public class _17_0_2_1_edc0357_1360798765471_478130_20630 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765471_478130_20630Members() {
                try {
                    ...
                    effect208 = new EffectFunction(new EffectFunction(effect208Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360798765471_478130_20630Dependencies() {
                ...
                addDependency(objectToPass, new Expression<Boolean>(new EffectFunction(sig_17_0_2_1_edc0357_1360798765477_228170_20659, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
            }
        ...
        public class _17_0_2_1_edc0357_1360798765472_324054_20632 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765472_324054_20632Members() {
                try {
                    ...
                    effect210 = new EffectFunction(new EffectFunction(effect210Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        public class _17_0_2_1_edc0357_1360798765473_313038_20633 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360798765473_313038_20633Members() {
                try {
                    ...
                    effect212 = new EffectFunction(new EffectFunction(effect212Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360798765473_313038_20633Dependencies() {
                addDependency(_17_0_2_1_edc0357_1360798765472_324054_20632_exists, new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Functions.Equals(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765468_931127_20626_exists), null)), new Expression<Boolean>(new Functions.Not(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765468_931127_20626_exists)))))), new Expression<Boolean>(new Functions.Less(new Expression<Integer>(new Functions.Plus(new Expression<Integer>(endTime), new Expression<Integer>(2))), new Expression<Integer>(finalNode_startTime)))))));
                addDependency(duration, new Expression<Integer>(300));
                addDependency(objectToPass, new Expression<Boolean>(new EffectFunction(sig_17_0_2_1_edc0357_1360798765478_663072_20665, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
            }
        ...
        public class _17_0_2_1_edc0357_1360878349175_589211_15843 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360878349175_589211_15843Members() {
                try {
                    ...
                    if (objectToPass == null) objectToPass = new BooleanParameter("objectToPass", (Boolean) null, this);
                    Object effect214VarV = load__17_0_2_1_edc0357_1360798765025_607442_20254;
                    effect214Var = new Parameter("effect214Var", null, null, this);
                    addDependency(effect214Var, new Expression(effect214VarV));
                    effect214 = new EffectFunction(new EffectFunction(effect214Var, ClassUtils.getMethodForArgTypes("TimeVaryingPlottableMap<Float>", "ROUND_TRIP_TEST", "setValue", gov.nasa.jpl.ae.event.Parameter.class, java.lang.Object.class), new Object[] { new Expression<Integer>(startTime), new Expression<Double>(_17_0_2_1_edc0357_1360878349177_108243_15844) }));
                    Object effect215VarV = sig_17_0_2_1_edc0357_1360798765476_328870_20652;
                    effect215Var = new Parameter("effect215Var", null, null, this);
                    addDependency(effect215Var, new Expression(effect215VarV));
                    effect215 = new EffectFunction(new EffectFunction(effect215Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360878349175_589211_15843Dependencies() {
                addDependency(_17_0_2_1_edc0357_1360798765467_857766_20624_exists, new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Functions.Equals(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765468_931127_20626_exists), null)), new Expression<Boolean>(new Functions.Not(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765468_931127_20626_exists)))))), new Expression<Boolean>(new Functions.Less(new Expression<Integer>(new Functions.Plus(new Expression<Integer>(endTime), new Expression<Integer>(2))), new Expression<Integer>(finalNode_startTime)))))));
                addDependency(_17_0_2_1_edc0357_1360878349177_108243_15844, new Expression<Double>(new EffectFunction(sig_17_0_2_1_edc0357_1360798765476_833192_20654, ClassUtils.getMethodForArgTypes("ObjectFlow<Float>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
                addDependency(duration, new Expression<Integer>(1));
                addDependency(objectToPass, new Expression<Boolean>(true));
            }
        ...
        public class _17_0_2_1_edc0357_1360878683758_623651_15865 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360878683758_623651_15865Members() {
                try {
                    ...
                    if (objectToPass == null) objectToPass = new BooleanParameter("objectToPass", (Boolean) null, this);
                    Object effect217VarV = powerAugmentation__17_0_2_1_edc0357_1360798765029_789574_20260;
                    effect217Var = new Parameter("effect217Var", null, null, this);
                    addDependency(effect217Var, new Expression(effect217VarV));
                    effect217 = new EffectFunction(new EffectFunction(effect217Var, ClassUtils.getMethodForArgTypes("TimeVaryingMap<Float>", "ROUND_TRIP_TEST", "add", java.lang.Number.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Double>(_17_0_2_1_edc0357_1360878683759_142586_15866), new Expression<Integer>(startTime) }));
                    Object effect218VarV = sig_17_0_2_1_edc0357_1360798765476_307646_20651;
                    effect218Var = new Parameter("effect218Var", null, null, this);
                    addDependency(effect218Var, new Expression(effect218VarV));
                    effect218 = new EffectFunction(new EffectFunction(effect218Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360878683758_623651_15865Dependencies() {
                addDependency(_17_0_2_1_edc0357_1360798765466_933706_20623_exists, new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Expression<Boolean>(new Functions.Or(new Expression<Boolean>(new Functions.Equals(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765468_931127_20626_exists), null)), new Expression<Boolean>(new Functions.Not(new Expression<Boolean>(_17_0_2_1_edc0357_1360798765468_931127_20626_exists)))))), new Expression<Boolean>(new Functions.Less(new Expression<Integer>(new Functions.Plus(new Expression<Integer>(endTime), new Expression<Integer>(2))), new Expression<Integer>(finalNode_startTime)))))));
                addDependency(_17_0_2_1_edc0357_1360878683759_142586_15866, new Expression<Double>(new EffectFunction(sig_17_0_2_1_edc0357_1360963130781_302800_23138, ClassUtils.getMethodForArgTypes("ObjectFlow<Float>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
                addDependency(duration, new Expression<Integer>(1));
                addDependency(objectToPass, new Expression<Boolean>(true));
            }
        ...
        public class _17_0_2_1_edc0357_1360878700672_703950_15878 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360878700672_703950_15878Members() {
                try {
                    ...
                    Object effect220VarV = new FunctionCall(signalObject, Parameter.class, "getMember", new Object[] { "control" });
                    effect220Var = new Parameter("effect220Var", null, null, this);
                    addDependency(effect220Var, new Expression(effect220VarV));
                    effect220 = new EffectFunction(new EffectFunction(null, ClassUtils.getMethodForArgTypes("TimeVaryingMap<Boolean>", "ROUND_TRIP_TEST", "setValue", gov.nasa.jpl.ae.event.Parameter.class, java.lang.Object.class), new Object[] { new Expression<Integer>(endTime), new Expression<Boolean>(true) }, effect220Var));
                    Object effect221VarV = new FunctionCall(x, Parameter.class, "getMember", new Object[] { "ss_17_0_2_1_edc0357_1360961106142_903091_22490_generation_ack" });
                    effect221Var = new Parameter("effect221Var", null, null, this);
                    addDependency(effect221Var, new Expression(effect221VarV));
                    effect221 = new EffectFunction(new EffectFunction(null, ClassUtils.getMethodForArgTypes("ObjectFlow<Signalgeneration_ack>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Power_System.Signalgeneration_ack>(signalObject), new Expression<Integer>(endTime) }, effect221Var));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360878700672_703950_15878Dependencies() {
                addDependency(duration, new Expression<Integer>(1));
                addDependency(objectToPass, new Expression<Boolean>(new EffectFunction(sig_17_0_2_1_edc0357_1360963135293_976442_23143, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
            }
        ...
        public class _17_0_2_1_edc0357_1360879079292_32519_15939 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360879079292_32519_15939Members() {
                try {
                    ...
                    effect222 = new EffectFunction(new EffectFunction(effect222Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Float>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Double>(_17_0_2_1_edc0357_1360879079294_5124_15941), new Expression<Integer>(endTime) }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360879079292_32519_15939Dependencies() {
                ...
                addDependency(_17_0_2_1_edc0357_1360879079294_5124_15941, new Expression<Double>(new EffectFunction(load__17_0_2_1_edc0357_1360798765025_607442_20254, ClassUtils.getMethodForArgTypes("TimeVaryingPlottableMap<Float>", "ROUND_TRIP_TEST", "getValue", java.lang.Integer.class), new Object[] { new Expression<Integer>(startTime) })));
                addDependency(duration, new Expression<Integer>(1));
                addDependency(objectToPass, new Expression<Boolean>(new EffectFunction(sig_17_0_2_1_edc0357_1360798765477_758751_20664, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
            }
        ...
        public class _17_0_2_1_edc0357_1360879079293_57273_15940 extends DurativeEvent {
            ...
            public void init_17_0_2_1_edc0357_1360879079293_57273_15940Members() {
                try {
                    ...
                    effect224 = new EffectFunction(new EffectFunction(effect224Var, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Boolean>(objectToPass), new Expression<Integer>(endTime) }));
                    Object effect225VarV = new FunctionCall(signalObject, Parameter.class, "getMember", new Object[] { "actual_load__17_0_2_1_edc0357_1360798765095_91554_20351" });
                    effect225Var = new Parameter("effect225Var", null, null, this);
                    addDependency(effect225Var, new Expression(effect225VarV));
                    effect225 = new EffectFunction(new EffectFunction(null, ClassUtils.getMethodForArgTypes("TimeVaryingMap<Float>", "ROUND_TRIP_TEST", "setValue", gov.nasa.jpl.ae.event.Parameter.class, java.lang.Object.class), new Object[] { new Expression<Integer>(endTime), new Expression<Double>(_17_0_2_1_edc0357_1360879079295_434103_15942) }, effect225Var));
                    Object effect226VarV = new FunctionCall(x, Parameter.class, "getMember", new Object[] { "ss_17_0_2_1_edc0357_1360798765027_973745_20257_receiveLoadReading" });
                    effect226Var = new Parameter("effect226Var", null, null, this);
                    addDependency(effect226Var, new Expression(effect226VarV));
                    effect226 = new EffectFunction(new EffectFunction(null, ClassUtils.getMethodForArgTypes("ObjectFlow<SignalreceiveLoadReading>", "ROUND_TRIP_TEST", "send", java.lang.Object.class, gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Power_System.SignalreceiveLoadReading>(signalObject), new Expression<Integer>(endTime) }, effect226Var));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void init_17_0_2_1_edc0357_1360879079293_57273_15940Dependencies() {
                ...
                addDependency(_17_0_2_1_edc0357_1360879079295_434103_15942, new Expression<Double>(new EffectFunction(sig_17_0_2_1_edc0357_1360879079295_184227_15943, ClassUtils.getMethodForArgTypes("ObjectFlow<Float>", "ROUND_TRIP_TEST", "receive", gov.nasa.jpl.ae.event.Parameter.class), new Object[] { new Expression<Integer>(startTime) })));
                addDependency(duration, new Expression<Integer>(1));
                addDependency(objectToPass, new Expression<Boolean>(true));
            }
        ...
        public void init_17_0_2_1_edc0357_1360798765022_187244_20251Dependencies() {
            addDependency(_17_0_2_1_edc0357_1360798765468_931127_20626_exists, new Expression<Boolean>(new Functions.And(new Expression<Boolean>(new Functions.NotEquals(new Expression<Integer>(finalNode_startTime), null)), new Expression(new EffectFunction(sig_17_0_2_1_edc0357_1360798765477_693138_20658, ClassUtils.getMethodForArgTypes("ObjectFlow<Boolean>", "ROUND_TRIP_TEST", "hasStuff", java.lang.Integer.class), new Object[] { new Expression<Integer>(new Functions.Minus(new Expression<Integer>(finalNode_startTime), new Expression<Integer>(1))) })))));
            addDependency(endTime, new Expression<Integer>(finalNode_endTime));
        }
    ...
    public void initPowerMembers() {
        try {
            ...
            if (genProfile__17_0_2_1_edc0357_1360798765028_430905_20259 == null) genProfile__17_0_2_1_edc0357_1360798765028_430905_20259 = new Parameter<TimeVaryingProjection<Float>>("genProfile__17_0_2_1_edc0357_1360798765028_430905_20259", null, (TimeVaryingProjection<Float>) (new ConstructorCall(null, ClassUtils.getConstructorForArgTypes(TimeVaryingProjection.class, java.lang.String.class, java.lang.String.class, java.lang.Object.class, java.lang.Class.class), new Object[] { "genProfile", "test_gen_dr.csv", null, Float.class })).evaluate(true), this);
