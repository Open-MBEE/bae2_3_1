...
public class BobCreator extends DurativeEvent {
    ...
    public void initBobCreatorMembers() {
        try {
            if (Bob == null) Bob = new Parameter<Power_System>("Bob", null, (Power_System) (new FunctionCall(this, ClassUtils.getMethodForArgTypes("BobCreator", "ROUND_TRIP_TEST", "new_Power_System"), new Object[] {})).evaluate(true), this);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
